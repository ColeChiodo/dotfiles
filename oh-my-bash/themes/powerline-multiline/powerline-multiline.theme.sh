...
USER_INFO_THEME_PROMPT_COLOR='#a9b665'
USER_INFO_THEME_PROMPT_SECONDARY_COLOR="#1d2021"
...
SCM_THEME_PROMPT_CLEAN_COLOR="#6c782e"    # color10 dark green
SCM_THEME_PROMPT_DIRTY_COLOR="#c14a4a"    # color9  dark red (already dark)
SCM_THEME_PROMPT_STAGED_COLOR="#b47109"   # muted dark gold
SCM_THEME_PROMPT_UNSTAGED_COLOR="#a0522d" # muted dark orange
...
CWD_THEME_PROMPT_COLOR="#303536"

LAST_STATUS_THEME_PROMPT_COLOR=196

CLOCK_THEME_PROMPT_COLOR="#303536"
...
VI_MODE_THEME_PROMPT_INSERT_COLOR="#a9b665"
VI_MODE_THEME_PROMPT_NORMAL_COLOR="#c14a4a"
